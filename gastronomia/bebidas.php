...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="container">
                <a href="./bebida/agregar.php" class="btn btn-danger">Agregar</a>
            </div>
            <br>
                    ...
                    <tbody>
                        ...
                        while ($fila = $resultado->fetch_assoc()) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../gastronomia/bebida/editar.php?id=<?php echo $fila["id"] ?>"
                                        class="btn btn-warning">editar</a>
                                    <a href="../gastronomia/bebida/funcioneliminar.php?id=<?php echo $fila["id"] ?>"
