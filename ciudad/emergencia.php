                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                            ...
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                ...
                                <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne"
                                    data-bs-parent="#sidenavAccordionPages">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="../ciudad/centro.php">Centro de la Ciudad</a>
                                        <a class="nav-link" href="../ciudad/emergencia.php">Servicios de emergencia</a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <center>
                        <h1 class="mt-4">Servicios de emergencia</h1>
                    </center>
                    <div class="container-fluid px-4">
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><a href="../principal.php">Menu Principal</a></li>
                            <li class="breadcrumb-item"><a>Servicios de emergencia</a></li>
                        </ol>
                    </div>
            </main>
            <div class="container">
                <a href="./emergencia/agregar.php" class="btn btn-danger">Agregar</a>
            </div>
            <br>
                    ...
                    <tbody>
                        ...
                        while ($fila = $resultado->fetch_assoc()) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../ciudad/emergencia/editar.php?id=<?php echo $fila["id"] ?>"
                                        class="btn btn-warning">editar</a>
                                    <a href="../ciudad/emergencia/funcioneliminar.php?id=<?php echo $fila["id"] ?>"
