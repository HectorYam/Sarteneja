        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <center>
                        <h1 class="mt-4">Imagenes de inicio</h1>
                    </center>
                    <div class="container-fluid px-4">
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><a href="index.html">Menu Principal</a></li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                En esta interfaz se administra las imagenes de la aplicacion movil.
                            </div>
                        </div>
                    </div>
            </main>
            <div class="container">
                <a href="./agregarimagen.php" class="btn btn-danger">Agregar</a>
            </div>
            <br>
                    ...
                    <tbody>
                        ...
                        while ($fila = $resultado->fetch_assoc()) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="editarimagen.php?id=<?php echo $fila["id"] ?>"
                                        class="btn btn-warning">editar</a>
                                    <a href="eliminarimagen.php?id=<?php echo $fila["id"] ?>"
