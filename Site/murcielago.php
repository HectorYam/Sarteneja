        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <center>
                        <h1 class="mt-4">Gruta Murciélago</h1>
                    </center>
                    <div class="container-fluid px-4">
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><a href="../principal.php">Menu Principal</a></li>
                            <li class="breadcrumb-item"><a>Murciélago</a></li>
                        </ol>
                    </div>
            </main>
            <div class="container">
                <a href="../grutas/murcielago/agregar.php" class="btn btn-danger">Agregar</a>
            </div>
            <br>
                    ...
                    <tbody>
                        ...
                        while ($fila = $resultado->fetch_assoc()) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../grutas/murcielago/editar.php?id=<?php echo $fila["id"] ?>"
                                        class="btn btn-warning">editar</a>
                                    <a href="../grutas/murcielago/funcioneliminar.php?id=<?php echo $fila["id"] ?>"
