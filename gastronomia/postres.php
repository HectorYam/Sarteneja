        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <center>
                        <h1 class="mt-4">Postre</h1>
                    </center>
                    <div class="container-fluid px-4">
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><a href="../principal.php">Menu Principal</a></li>
                            <li class="breadcrumb-item"><a>Postres</a></li>
                        </ol>
                    </div>
            </main>
            <div class="container">
                <a href="./postre/agregar.php" class="btn btn-danger">Agregar</a>
            </div>
            <br>
                    ...
                    <tbody>
                        ...
                        while ($fila = $resultado->fetch_assoc()) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../gastronomia/postre/editar.php?id=<?php echo $fila["id"] ?>"
                                        class="btn btn-warning">editar</a>
                                    <a href="../gastronomia/postre/funcioneliminar.php?id=<?php echo $fila["id"] ?>"
