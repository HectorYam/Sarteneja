...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                En esta interfaz se abministra los comentarios proporcionados mediante la aplicacion
                                movil.
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <a href="./forms/agregar.php" class="btn btn-danger"> Agregar </a>
            </div>
            <br>
                    ...
                    <tbody>
                        ...
                        while ($fila = mysqli_fetch_array($query)) {
                            ...
                            <tr>
                                ...
                                <th scope="row">
                                    <a href="forms/editar.php?id=<?php echo $fila['id'] ?>"
                                        class="btn btn-warning">Editar</a>
                                    <a href="crud/eliminar.php?id=<?php echo $fila['id'] ?>"
